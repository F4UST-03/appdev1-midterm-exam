        ...
        <div className="col-12">
          <nav className="main-nav">
            ...
            <a href="index.html" className="logo">
              <img src="/vendor/images/logo.png" alt="Chain App Dev" />
            </a>
            {/* ***** Logo End ***** */}
            {/* ***** Menu Start ***** */}
            <ul className="nav">
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div
                ...
                data-wow-delay="0.5s"
              >
                <img src="/vendor/images/slider-dec.png" alt="" />
              </div>
            </div>
          </div>
        </div>
...
<div className="the-clients">
  <div className="section-heading">
    <h2>Check What <span>The Clients</span> Say About Our App Dev</h2>
  ...
  <div className="naccs">
    <div className="menu">
      ...
      <div className="thumb">
        <span className="date">28 November 2021</span>
        <h4>Jake Mareno App</h4>
        <span className="category">Digital Content</span>
        <span className="rating">★★★★★ 4.5</span>
      </div>
      <div className="thumb">
        <span className="date">27 November 2021</span>
        <h4>Ray Cahzman</h4>
        <span className="category">Distribution & Essentials</span>
    ...
    <div className="right-side">
      ...
      <div className="down-content">
        <img src="/vendor/images/client-image.jpg" alt="Client" />
      ...
      <div className="row">
        ...
        <div className="col-lg-4">
          <div className="pricing-item-regular">
            ...
            <div className="icon">
              <img src="/vendor/images/pricing-table-01.png" alt="" />
            </div>
            <ul>
      ...
      <div className="row">
        ...
        <div className="col-lg-3">
          <div className="footer-widget">
            ...
            <div className="logo">
              <img src="/vendor/images/white-logo.png" alt="" />
            </div>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
